...
public Producto(int idProducto1,String idProducto, String nomProducto, int stockProducto, String idProveedorProducto,  double precioCompraProducto, 
		double precioVentaProducto, int existenciasProducto,double iva, double bon1, double bon2, double bon3, double bon4, double flete,double ganancia, String nom_proveedor, String nom_Categoria) {
...
public Producto(int idProducto1,String idProducto, String nomProducto, int stockProducto, String idProveedorProducto,  double precioCompraProducto, double precioVentaProducto, int existenciasProducto, int idCategoria, int idProveedor,double iva,
